    ...
    */
    ...
    static func refreshAllList(){
        ...
        for elem in GlobalData.array{
            ...
            let str = elem["nameKana"] as! String
            ...
            GlobalData.getRefferenceList((str as NSString).substringToIndex(1)).addObject(elem)
            GlobalData.addSection((str as NSString).substringToIndex(1))
        }
